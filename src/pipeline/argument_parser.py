...
def add_necessary_arguments_to_parser():
	...
	parser.add_argument('--epoch', default=1, type=int, help='The number of epochs to train for.')
	...
	parser.add_argument('--ihls', default=48, type=int, help='The dimension of initial the hidden layer.')
